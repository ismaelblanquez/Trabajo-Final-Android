...
public class HotelsRatingActivity extends AppCompatActivity implements HotelAdapter.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Query query = mFirebase.collection("Hotel").orderBy("rating", Query.Direction.DESCENDING);
